...
const HomeDetail = () => {
  ...
  const houses = [
    ...
    { id: 2, title: "Modern Apartment", city: "Delhi", price: "₹2500 / night", description: "Modern apartment with city view, fully furnished.", images: ["/images.jpeg", "https://source.unsplash.com/800x500/?modern,apartment"] },
